...
const TEXT = {
    fr: {
        ...
        titlePrefix: "Ensemble, construisons une ",
        titleHighlight: "génération",
        titleSuffix: " consciente et distinguée",
        lead: "Une plateforme numérique qui rassemble les étudiants de la wilaya autour des valeurs du savoir, de la solidarité et de l'excellence, tout en leur offrant des informations, des services et des initiatives qui les aident à réaliser leurs ambitions académiques et professionnelles.",
    ...
    en: {
        ...
        titlePrefix: "Together, We Build an Aware and Outstanding ",
        titleHighlight: "Generation",
        titleSuffix: "",
        lead: "A digital platform that brings together students of the region around the values of knowledge, solidarity, and excellence, while providing information, services, and initiatives that help them achieve their academic and professional ambitions.",
    ...
    ar: {
        ...
        titleHighlight: "جيلًا",
        titleSuffix: " واعيًا ومتميزًا",
        lead: "منصة رقمية تجمع أبناء الولاية حول قيم العلم والتضامن والتميز، وتعمل على دعم الطلاب وتوفير المعلومات والخدمات والمبادرات التي تساعدهم على تحقيق طموحاتهم العلمية والمهنية.",
